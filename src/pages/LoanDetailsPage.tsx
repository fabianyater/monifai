...
import { CreateLoanPaymentModal } from "../components/molecules/CreateLoanPaymentModal";
  ...
  const menuItems =
    loanType === "LENDER"
      ? [
          ...
          { label: "Aumentar a recibir", icon: "pi pi-plus" },
        ]
      : [
          {
            label: "Reembolso",
          ...
          { label: "Aumentar deuda", icon: "pi pi-plus" },
        ];
          ...
          <div className="w-full flex flex-col gap-2 rounded-xl mt-3">
            <div className="flex items-center justify-between">
              <div className="flex flex-col items-start">
                <span>
                  {data.loanType === "LENDER" ? "Recibido" : "Pagado"}
                </span>
